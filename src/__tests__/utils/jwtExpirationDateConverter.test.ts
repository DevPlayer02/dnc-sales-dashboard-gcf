...
describe('jwtExpirationDateConverter', () => {
  ...
  beforeAll(() => {
    global.Date.now = jest.fn(() => new Date('2024-03-01T00:00:00Z').getTime())
  })
  ...
  it('should correctly converter wxpiration date in a fraction of day. 12 hours in the future', () => {
