...
function Profile() {
  ...
  const handleDelete = async () => {
    if (
      confirm(
        'Tem certeza que deseja excluir sua conta? Se sim, certifique-se de remover os seus leads antes'
      ) === true
    )
      try {
        ...
        alert(
          'Não foi possível realizar essa operação. Entre em contato com nosso suporte.'
        )
      }
  }
